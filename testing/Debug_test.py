...
def main():
    ...
    try:
        ...
        # Get or create the user (discord_id "123456789")
        ...
        rec_item = create_recommended_item(
            ...
            price=999.99,
            metadata={"color": "black"}  # This will be stored in the column "metadata"
        )
        ...
        # Optionally, fetch back the user for verification.
